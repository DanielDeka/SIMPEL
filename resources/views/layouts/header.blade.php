...
<link rel="shortcut icon" href="{{asset('assets/codebase/assets/img/favicons/favicon.png')}}">
...
<!-- Page JS Code -->
<script src="{{asset('assets/codebase/assets/js/pages/be_pages_dashboard.js')}}"></script>